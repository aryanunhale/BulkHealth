...
# Map: local path -> Healthkart CDN URL
IMAGE_MAP = {
...
# Read with latin-1 to preserve raw bytes (handles the mojibake)
with open(src_path, 'r', encoding='latin-1') as f:
    content = f.read()

# Fix mojibake: windows-1252 em-dash read as latin-1 -> decode as cp1252 then encode as utf-8
# The sequence â€" is U+2013 (en-dash) encoded as UTF-8 bytes read as latin-1
